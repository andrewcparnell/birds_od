...
# Plot requirements
plot_dims = c(8,6) # This is the width and heigth at which to save all plots
...
count = 1
for(i in 1:2) {
  od_pars[[count]] = all_pars[[i]]$theta_dairy
  od_pars[[count+1]] = all_pars[[i]]$theta_winter
  od_pars[[count+2]] = all_pars[[i]]$theta_dairy_winter
  count = count+3
}  
